...
{
	var collection_div = jQuery("#item-citation")[0];
	...
	categories.className = 'element-text';
	categories.innerHTML = '<h2>Categories</h2>';

	categories_inner.className = 'element-text';
